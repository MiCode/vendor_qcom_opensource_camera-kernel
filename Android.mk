...
ifeq ($(XIAOMI_CAMERA_ODM_ANNIBALE_SERIES_UPGRADE), true)
...
LOCAL_MODULE_DDK_EXTRA_ARGS := "--//vendor/qcom/opensource/camera-kernel-annibale:project_name=$(TARGET_BOARD_PLATFORM)"
endif
