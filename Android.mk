...
ifeq ($(XIAOMI_CAMERA_ODM_WARSAW_SERIES_UPGRADE), true)
...
LOCAL_MODULE_DDK_EXTRA_ARGS := "--//vendor/qcom/opensource/camera-kernel-warsaw:project_name=$(TARGET_BOARD_PLATFORM)"
endif
