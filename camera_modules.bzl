...
def _define_module(target, variant):
    ...
    base_deps = select({
        "//build/kernel/kleaf:socrepo_true": [
            ...
            "//soc-repo:{}/drivers/misc/hwid".format(tv),               #xiaomi add
        ],
        ...
        conditional_srcs = {
            ...
            "CONFIG_SPECTRA_SENSOR": {
                True: [
                    ...
                    "drivers/cam_sensor_module/cam_zoom/cam_zoom_dev.c",
                    "drivers/cam_sensor_module/cam_zoom/cam_zoom_core.c",
                    "drivers/cam_sensor_module/cam_zoom/cam_zoom_soc.c",
                    "drivers/cam_sensor_module/cam_zoom/Sem1218s_zoom.c",
                    "drivers/cam_sensor_module/cam_sensor_module_debug.c",
                    "drivers/cam_sensor_module/cam_sensor_utils/cam_parklens_thread.c",
                    "drivers/cam_sensor_module/cam_sensor_io/xm_cam_dev_protection.c"
                ],
            },
    ...
    kernel_module_group(
        name = "{}_camera_modules".format(tv),
        srcs = [
            ":{}_camera".format(tv),
        ],
    )
    ...
    copy_to_dist_dir(
        ...
        data = [":{}_camera_modules".format(tv)],
