	...
	struct csiphy_device *csiphy_dev)
{
	...
	/* xiaomi add cphy reg - begin */
	} else if(of_device_is_compatible(soc_info->dev->of_node, "qcom,csiphy-v2.3.0-0")) {
		// XIAOMI ADD: FeatureAutoEQ
		strncpy(csiphy_dev->phy_dts_name, "qcom,csiphy-v2.3.0-0", strlen("qcom,csiphy-v2.3.0-0"));
		// END: FeatureAutoEQ
		csiphy_dev->ctrl_reg = &ctrl_reg_2_3_0_0;
		csiphy_dev->hw_version = CSIPHY_VERSION_V230;
		csiphy_dev->is_divisor_32_comp = true;
		csiphy_dev->clk_lane = 0;
	} else if(of_device_is_compatible(soc_info->dev->of_node, "qcom,csiphy-v2.3.0-2")){
		// XIAOMI ADD: FeatureAutoEQ
		strncpy(csiphy_dev->phy_dts_name, "qcom,csiphy-v2.3.0-2", strlen("qcom,csiphy-v2.3.0-2"));
		// END: FeatureAutoEQ
		...
		csiphy_dev->is_divisor_32_comp = true;
		csiphy_dev->clk_lane = 0;
	} else if(of_device_is_compatible(soc_info->dev->of_node, "qcom,csiphy-v2.3.0-o3")){
		// XIAOMI ADD: FeatureAutoEQ
		strncpy(csiphy_dev->phy_dts_name, "qcom,csiphy-v2.3.0-o3", strlen("qcom,csiphy-v2.3.0-o3"));
		// END: FeatureAutoEQ
		csiphy_dev->ctrl_reg = &ctrl_reg_2_3_0_o3;
		csiphy_dev->hw_version = CSIPHY_VERSION_V230;
		csiphy_dev->is_divisor_32_comp = true;
		csiphy_dev->clk_lane = 0;
	} else {
