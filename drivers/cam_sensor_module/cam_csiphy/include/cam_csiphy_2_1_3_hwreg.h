...
struct csiphy_reg_t csiphy_2ph_v2_1_3_clk_ln_reg[] = {
...
struct csiphy_reg_t datarate_213_100Msps[] = {
	...
	{0x008C, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
...
struct csiphy_reg_t datarate_213_600Msps[] = {
	...
	{0x0078, 0x70, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0088, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x008C, 0x12, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x006C, 0x11, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0090, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0014, 0x20, 0x00, CSIPHY_DEFAULT_PARAMS},
};
...
struct csiphy_reg_t datarate_213_2p6Gsps[] = {
	...
	{0x0078, 0x28, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0088, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x008C, 0x22, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x006C, 0x1A, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0090, 0x03, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0014, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
};
...
struct csiphy_reg_t datarate_213_3p0Gsps[] = {
	...
	{0x0088, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x008C, 0x34, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x006C, 0x1A, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0090, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0014, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
};
...
struct csiphy_reg_t datarate_213_5Gsps[] = {
	...
	{0x0074, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0078, 0x0C, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0088, 0x50, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x008C, 0x45, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x006C, 0x24, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0090, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0014, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
};
...
struct csiphy_reg_parms_t csiphy_v2_1_3 = {
	...
	.csiphy_2ph_clk_cfg_array_size = ARRAY_SIZE(csiphy_2ph_v2_1_3_clk_ln_reg),
...
struct csiphy_ctrl_t ctrl_reg_2_1_3 = {
	...
	.csiphy_2ph_clk_ln_reg = csiphy_2ph_v2_1_3_clk_ln_reg,
