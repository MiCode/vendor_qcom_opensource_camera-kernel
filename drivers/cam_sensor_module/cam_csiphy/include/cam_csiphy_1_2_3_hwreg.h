...
struct csiphy_reg_t csiphy_2ph_v1_2_3_reg[MAX_LANES][MAX_SETTINGS_PER_LANE] = {
	{
		...
		{0x0004, 0x2F, 0x00, CSIPHY_DEFAULT_PARAMS},
	...
	},
	{
		...
		{0x0710, 0x72, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x071C, 0x0A, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0714, 0x20, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x073C, 0xB8, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0704, 0x2F, 0x00, CSIPHY_DEFAULT_PARAMS},
	...
	},
	{
		...
		{0x0210, 0x72, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x021C, 0x0A, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0214, 0x20, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x023C, 0xB8, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0204, 0x2F, 0x00, CSIPHY_DEFAULT_PARAMS},
	...
	},
	{
		...
		{0x0404, 0x2F, 0x00, CSIPHY_DEFAULT_PARAMS},
	...
	},
	{
		...
		{0x0610, 0x72, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x061C, 0x0A, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0614, 0x20, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x063C, 0xB8, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0604, 0x2F, 0x00, CSIPHY_DEFAULT_PARAMS},
