...
struct csiphy_reg_t csiphy_2ph_v2_2_0_clk_ln_reg[] = {
...
struct csiphy_reg_t datarate_220_80Msps[] = {
	...
	{0x006C, 0x05, 0x00, CSIPHY_SHORT_CHANNEL_PARAMS},
	{0x006C, 0x05, 0x00, CSIPHY_STANDARD_CHANNEL_PARAMS},
	{0x008C, 0x30, 0x00, CSIPHY_SHORT_CHANNEL_PARAMS},
	{0x008C, 0x37, 0x00, CSIPHY_STANDARD_CHANNEL_PARAMS},
...
struct csiphy_reg_t datarate_220_1p2Gsps[] = {
	...
	{0x0088, 0x20, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x006C, 0x3D, 0x00, CSIPHY_SHORT_CHANNEL_PARAMS},
	{0x006C, 0x05, 0x00, CSIPHY_STANDARD_CHANNEL_PARAMS},
	{0x008C, 0x30, 0x00, CSIPHY_SHORT_CHANNEL_PARAMS},
	{0x008C, 0x37, 0x00, CSIPHY_STANDARD_CHANNEL_PARAMS},
	{0x0070, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
...
struct csiphy_reg_t datarate_220_2p6Gsps[] = {
	...
	{0x0088, 0x20, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x006C, 0x3D, 0x00, CSIPHY_SHORT_CHANNEL_PARAMS},
	{0x006C, 0x2D, 0x00, CSIPHY_STANDARD_CHANNEL_PARAMS},
	{0x008C, 0x30, 0x00, CSIPHY_SHORT_CHANNEL_PARAMS},
	{0x008C, 0x37, 0x00, CSIPHY_STANDARD_CHANNEL_PARAMS},
...
struct csiphy_reg_t datarate_220_4p0Gsps[] = {
	...
	{0x0068, 0xF1, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0094, 0x01, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0078, 0x0C, 0x00, CSIPHY_CDR_LN_SETTINGS | CSIPHY_SHORT_CHANNEL_PARAMS},
	{0x0078, 0x0C, 0x00, CSIPHY_CDR_LN_SETTINGS | CSIPHY_STANDARD_CHANNEL_PARAMS},
	{0x0088, 0x20, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x006C, 0x3D, 0x00, CSIPHY_SHORT_CHANNEL_PARAMS},
	{0x006C, 0x2D, 0x00, CSIPHY_STANDARD_CHANNEL_PARAMS},
	{0x008C, 0x30, 0x00, CSIPHY_SHORT_CHANNEL_PARAMS},
...
struct csiphy_reg_t datarate_220_5p0Gsps[] = {
	/* AFE Settings */
	{0x0068, 0x41, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0094, 0x01, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0078, 0x82, 0x00, CSIPHY_CDR_LN_SETTINGS | CSIPHY_SHORT_CHANNEL_PARAMS},
	{0x0078, 0x82, 0x00, CSIPHY_CDR_LN_SETTINGS | CSIPHY_STANDARD_CHANNEL_PARAMS},
	{0x0088, 0x20, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x006C, 0x03, 0x00, CSIPHY_SHORT_CHANNEL_PARAMS},
	{0x006C, 0x3F, 0x00, CSIPHY_STANDARD_CHANNEL_PARAMS},
	{0x008C, 0x33, 0x00, CSIPHY_SHORT_CHANNEL_PARAMS},
	{0x008C, 0x37, 0x00, CSIPHY_STANDARD_CHANNEL_PARAMS},
	{0x0070, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0074, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
	/* Datarate Sensitive */
...
struct csiphy_reg_t datarate_220_5p5Gsps[] = {
	...
	{0x0068, 0x41, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0094, 0x01, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0078, 0x80, 0x00, CSIPHY_CDR_LN_SETTINGS | CSIPHY_SHORT_CHANNEL_PARAMS},
	{0x0078, 0x81, 0x00, CSIPHY_CDR_LN_SETTINGS | CSIPHY_STANDARD_CHANNEL_PARAMS},
	{0x0088, 0x20, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x006C, 0x03, 0x00, CSIPHY_SHORT_CHANNEL_PARAMS},
	{0x006C, 0x3F, 0x00, CSIPHY_STANDARD_CHANNEL_PARAMS},
	{0x008C, 0x33, 0x00, CSIPHY_SHORT_CHANNEL_PARAMS},
...
struct csiphy_reg_parms_t csiphy_v2_2_0 = {
	...
	.csiphy_2ph_clk_cfg_array_size = ARRAY_SIZE(csiphy_2ph_v2_2_0_clk_ln_reg),
...
struct csiphy_ctrl_t ctrl_reg_2_2_0 = {
	...
	.csiphy_2ph_clk_ln_reg = csiphy_2ph_v2_2_0_clk_ln_reg,
