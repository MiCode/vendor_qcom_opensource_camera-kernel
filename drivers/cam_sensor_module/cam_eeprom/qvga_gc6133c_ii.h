#ifndef _QVGA_GC6133C_II_H_
#define _QVGA_GC6133C_II_H_
...
#define QVGA_GC6133C_SLAVE_ADDR      0x80
#define QVGA_GC6133C_SLAVE_ADDR_REG  0xf0
#define QVGA_GC6133C_LUX_DATA_REG            0x93
#define QVGA_GC6133C_LUX_DATA_EN_REG         0xfe
#define QVGA_GC6133C_LUX_DATA_EN_REG_VALUE   0x00

struct eeprom_memory_map_init_write_params qvga_gc6133c_hw_on_reset_setting  ={
	.slave_addr = QVGA_GC6133C_SLAVE_ADDR,
	.mem_settings =
	{
...
struct eeprom_memory_map_init_write_params qvga_gc6133c_hw_off_reset_setting  ={
	.slave_addr = QVGA_GC6133C_SLAVE_ADDR,
	.mem_settings =
	{
...
struct eeprom_memory_map_init_write_params qvga_gc6133c_setting  ={
	.slave_addr = QVGA_GC6133C_SLAVE_ADDR,
	.mem_settings =
	{
		...
		{0x03, CAMERA_SENSOR_I2C_TYPE_BYTE, 0x01, CAMERA_SENSOR_I2C_TYPE_BYTE, 0},
		{0x04, CAMERA_SENSOR_I2C_TYPE_BYTE, 0xf4, CAMERA_SENSOR_I2C_TYPE_BYTE, 0},
		...
		{0x22, CAMERA_SENSOR_I2C_TYPE_BYTE, 0xf8, CAMERA_SENSOR_I2C_TYPE_BYTE, 0},
		...
		{0x90, CAMERA_SENSOR_I2C_TYPE_BYTE, 0x60, CAMERA_SENSOR_I2C_TYPE_BYTE, 0},//20160901
		...
		{0xa0, CAMERA_SENSOR_I2C_TYPE_BYTE, 0x21, CAMERA_SENSOR_I2C_TYPE_BYTE, 0}, //pregain
		{0xa1, CAMERA_SENSOR_I2C_TYPE_BYTE, 0xf4, CAMERA_SENSOR_I2C_TYPE_BYTE, 0}, //pregain
		{0xa3, CAMERA_SENSOR_I2C_TYPE_BYTE, 0x20, CAMERA_SENSOR_I2C_TYPE_BYTE, 0}, //pregain
...
static int get_qvga_lux_data_gc6133c(struct cam_eeprom_ctrl_t *e_ctrl){
	...
	i2c_reg_array.reg_addr = QVGA_GC6133C_LUX_DATA_EN_REG;
	i2c_reg_array.reg_data = QVGA_GC6133C_LUX_DATA_EN_REG_VALUE;
	...
	camera_io_dev_read( &(e_ctrl->io_master_info),
				QVGA_GC6133C_LUX_DATA_REG, &lux, CAMERA_SENSOR_I2C_TYPE_BYTE,
...
static void qvga_hw_off_reset_gc6133c(struct cam_eeprom_ctrl_t *e_ctrl){
	...
	int rc = 0;
	pWriteParams = &qvga_gc6133c_hw_off_reset_setting;
...
static void qvga_hw_on_reset_gc6133c(struct cam_eeprom_ctrl_t *e_ctrl){
	...
	uint32_t count_write;
	int rc = 0;
	pWriteParams = &qvga_gc6133c_hw_on_reset_setting;
	for(count_write=0;count_write < pWriteParams->memory_map_size; count_write++) {
		i2c_reg_settings.addr_type = pWriteParams->mem_settings[count_write].addr_type;
		i2c_reg_settings.data_type = pWriteParams->mem_settings[count_write].data_type;
		i2c_reg_settings.size = 1;
...
static void init_qvga_setting_gc6133c(struct cam_eeprom_ctrl_t *e_ctrl){
	...
	uint32_t count_write;
	int rc = 0;
	pWriteParams = &qvga_gc6133c_setting;
	for(count_write=0;count_write < pWriteParams->memory_map_size; count_write++) {
		i2c_reg_settings.addr_type = pWriteParams->mem_settings[count_write].addr_type;
		i2c_reg_settings.data_type = pWriteParams->mem_settings[count_write].data_type;
		i2c_reg_settings.size = 1;
...
static ssize_t qvga_get_name_gc6133c(int driver_flag, char *buf)
{
	ssize_t len = 0;
	if (driver_flag) {
