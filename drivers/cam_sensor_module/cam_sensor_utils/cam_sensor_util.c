	...
	for (j = 0; j < num_vreg; j++) {
		if (!strcmp(soc_info->rgltr_name[j], "cam_clk")) {
			...
			if (ps != NULL) {
				...
				//xiaomi add
				cam_debug_record_key_message(-1,(void *)ctrl,(void *)soc_info,index,j,EVENT_POWER_DOWN);
				//end
		...
		struct cam_hw_soc_info *soc_info, struct completion *i3c_probe_status)
{
	...
	for (index = 0; index < ctrl->power_setting_size; index++) {
		...
		case SENSOR_MCLK:
			...
			//xiaomi add
			cam_debug_record_key_message(-1,(void *)ctrl,(void *)soc_info,index,idx,EVENT_POWER_UP);
			//end
			break;
		case SENSOR_RESET:
		case SENSOR_STANDBY:
		...
		case SENSOR_CUSTOM_GPIO2:
			...
			//xiaomi add
			cam_debug_record_key_message(-1,(void *)ctrl,(void *)soc_info,index,-1,EVENT_POWER_UP);
			//end
			break;
		case SENSOR_VANA:
		case SENSOR_VANA1:
		...
		struct cam_hw_soc_info *soc_info)
{
	...
	for (index = 0; index < ctrl->power_down_setting_size; index++) {
		...
		case SENSOR_CUSTOM_GPIO2:
			...
			//xiaomi add
			cam_debug_record_key_message(-1,(void *)ctrl,(void *)soc_info,index,0,EVENT_POWER_DOWN);
			//end
			break;
		case SENSOR_VANA:
		case SENSOR_VANA1:
		...
		/* xiaomi add end*/
			...
			//xiaomi add
			cam_debug_record_key_message(-1,(void *)ctrl,(void *)soc_info,index,pd->seq_val,EVENT_POWER_DOWN);
			//end
			break;
		default:
			CAM_ERR(CAM_SENSOR_UTIL, "error power seq type %d",
