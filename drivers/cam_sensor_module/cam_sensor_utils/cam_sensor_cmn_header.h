...
#define CAM_ZOOM_NAME      "cam-zoom"  //xiaomi add
...
enum cam_sensor_i2c_cmd_type {
	...
	CAM_SENSOR_I2C_POLL,
	CAM_SENSOR_I2C_POLL_NOT_EQUAL //xiaomi add
};
...
struct i2c_data_settings {
	...
	struct i2c_settings_array delay_config_settings; //xiaomi add
