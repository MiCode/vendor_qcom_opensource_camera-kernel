...
/* xiaomi add disable debug log default,use sys to enable debug log begin */
	hw_mgr->icp_dbg_lvl = 1;
/* xiaomi add disable debug log default,use sys to enable debug log end */
