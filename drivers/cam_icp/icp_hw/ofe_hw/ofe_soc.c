...
static inline int cam_ofe_set_gdsc_mode(struct cam_hw_soc_info *soc_info,
...
{
	return cam_ofe_set_gdsc_mode(soc_info, CAM_GDSC_HW_CONTROL);
}

int cam_ofe_get_gdsc_control(struct cam_hw_soc_info *soc_info)
{
	return cam_ofe_set_gdsc_mode(soc_info, CAM_GDSC_SW_CONTROL);
}
