...
static struct cam_ife_csid_irq_desc cam_ife_csid_680_rx_irq_desc[][32] = {
	{
		{
			.bitmask = BIT(0),
			.desc = "DL0_EOT",
...
static uint32_t cam_ife_csid_680_num_rx_irq_desc[] = {
	ARRAY_SIZE(cam_ife_csid_680_rx_irq_desc[0]),
};

static struct cam_ife_csid_irq_desc cam_ife_csid_680_path_irq_desc[] = {
	{
		.bitmask = BIT(0),
		.desc = "",
	},
...
static struct cam_ife_csid_rx_debug_mask cam_ife_csid_680_rx_debug_mask = {
...
static struct cam_ife_csid_top_debug_mask cam_ife_csid_680_top_debug_mask = {
	.evt_bitmap = { 0ULL,},
};
